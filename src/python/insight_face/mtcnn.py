...
from src.python.insight_face.mtcnn_pytorch.src.box_utils import nms, calibrate_box, \
    get_image_boxes, convert_to_square
...
class MTCNN:
    def __init__(self):
        self.device = get_config(False).device
    ...
    def align_multi(self, img, limit=None, min_face_size=30.0, boxes=None, landmarks=None):
    ...
    def detect_faces(self, image, min_face_size=20.0,
        ...
        with no_grad():
            ...
            img_boxes = FloatTensor(img_boxes).to(self.device)
